...
import com.clinicaOdontologica.clinicaOdontologica.model.Rol;
...
public class UserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String s) throws UsernameNotFoundException {
        Optional<com.clinicaOdontologica.clinicaOdontologica.model.User> user = userRepository.getUserByName(s);
